...
A real-time 2D particle simulation utilizing Python for the graphical interface and a C backend for computations. It collision physics, dynamic DBSCAN clustering, and a quadtree spatial partitioning implementation to optimize performance.
...
* **Interactive GUI:** Adjust parameters like EPS distance, MinPts, particle count on the fly using PyQtGraph.
